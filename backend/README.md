...
## Project Structure
    ...
    ├── weathered_lake_dev_80383  # Django project configurations
...
1. Clone this repo and `cd weathered_lake_dev_80383`
...
2. Clone this repo and `cd weathered_lake_dev_80383`
