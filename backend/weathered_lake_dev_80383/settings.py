"""
Django settings for weathered_lake_dev_80383 project.
...
ROOT_URLCONF = 'weathered_lake_dev_80383.urls'
...
WSGI_APPLICATION = 'weathered_lake_dev_80383.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_lake_dev_80383 API",
    "DESCRIPTION": "API documentation for weathered_lake_dev_80383 App",
    "VERSION": "v1",
}
